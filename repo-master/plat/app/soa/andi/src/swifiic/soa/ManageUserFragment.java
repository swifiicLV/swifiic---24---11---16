...
public class ManageUserFragment extends Fragment implements OnItemClickListener,OnItemLongClickListener {
    ...
    private ArrayList<Pair<String,String>> commonNameValuePairs ;
	...
	//	HttpResponse response = null;
		...
		//    	    Boolean.FALSE);
	        ...
	        // Adding the user Id for transactions and the request Tag 
		      if (isTransaction){
		    		nameValuePairs.add(new Pair<>(Constants.userKeyID_tag,userId));
		    		nameValuePairs.add(new Pair<>(Constants.name_tag,"GetTransactions"));
			   }
		      else  nameValuePairs.add(new Pair<>(Constants.name_tag,"ListUser"));
...
private class DeleteUserTask extends AsyncTask<String,Void,Void>{
	...
	//	HttpClient httpclient = new DefaultHttpClient();
	  //  HttpPost httppost = new HttpPost("http://"+url+"/HubSrvr/Oprtr");
	    ...
	    nameValuePairs.addAll(commonNameValuePairs);
	    nameValuePairs.add(new Pair<>(Constants.name_tag,"DeleteUser"));
	    nameValuePairs.add(new Pair<>(Constants.userKeyID_tag,userId));
	   // httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
      //  response = httpclient.execute(httppost);
...
private class RechargeUserTask extends AsyncTask<String,Void,Void>{
	...
	//    HttpPost httppost = new HttpPost("http://"+url+"/HubSrvr/Oprtr");
	   ...
	   ArrayList<Pair<String,String>> nameValuePairs = new ArrayList<>();
	    ...
	    nameValuePairs.addAll(commonNameValuePairs);
	    nameValuePairs.add(new Pair<>(Constants.name_tag,"RechargeUser"));

		nameValuePairs.add(new Pair<>(Constants.CreditUserId_tag,userId));
	    
	    nameValuePairs.add(new Pair<>(Constants.Amount_tag,recharge));
	    nameValuePairs.add(new Pair<>(Constants.EventNotes_tag,event+" from SOA app"));
	    nameValuePairs.add(new Pair<>(Constants.Details_tag,event));
