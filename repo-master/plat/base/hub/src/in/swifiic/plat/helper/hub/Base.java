...
public class  Base{
	...
	private LogBase logger = new LogBase() ; 
    ...
    protected void send(String destinationAddress, String message) {
        ...
        //LOGGER.log(Level.SEVERE,"Sending a bundle to: " + destination.toString() + "\n with data: " + message) ;
          logger.logBase("Sending a bundle to: " + destination.toString() + "\n with data: " + message) ;
    ...
    protected void sendGrp(String destinationAddress, String message) {
        ...
        //LOGGER.log(Level.SEVERE,"Sending a bundle to Group: " + destination.toString() + "\n with data: " + message) ;
          logger.logBase("Sending a bundle to Group: " + destination.toString() + "\n with data: " + message) ;
        dtnClient.send(finalBundle);    	
    }
}
