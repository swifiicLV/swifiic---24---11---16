...
public class DataReceiver extends Thread implements SABHandler {
    ...
    public void run() {
        try {
            ...
            logger.logAPI("(from IBRAPI) Parsing input stream failed" +  e.getMessage());
            client.mark_error();
        }
    }
    ...
    public void startBundle() {
         logger.logAPI("Starting bundle.");
        current_bundle = new Bundle();
    }

    @Override
    public void endBundle() {
        logger.logAPI("Ending bundle.");
    ...
    public void endBlock() {
        ...
        if (outputStream != null) {
            ...
            try {
                ...
                logger.logAPI("(from IBRAPI) Failed to flush output writer" + e);
            }
    ...
    public void characters(String data) throws SABException {
        ...
        if (outputWriter != null) {
            try {
                ...
                logger.logAPI("(from IBRAPI) Cannot write data to output stream." +  e);
            }
    ...
    public void notify(Integer type, String data) {
        ...
        switch (type) {
            case 600: // COMMON
                logger.logAPI("(from IBRAPI) 600 COMMON notification " + data);
                break;
            case 601: // NEIGHBOR 
                logger.logAPI("(from IBRAPI) 601 NEIGHBOR notification " + data);
                break;
            case 602: // BUNDLE
